...
avatar.src = user.img || "default-avatar.png";
...
// Google API key
const GOOGLE_API_KEY = "AIzaSyDuVpB8TrClVHUtUyujbJIqWzz5ItBYPbc";
...
if (savedConversations.length > 50) savedConversations.shift(); 
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src={} alt="User avatar">
        ...
        if (!responseText) {
            console.error("Ошибка: API не вернул текст.");
            messageTextElement.innerText = "Ошибка: Пустой ответ от сервера.";
            return;
        }
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/profile.png" alt="ai avatar">
...
const requestApiResponse = async (incomingMessageElement) => {
    ...
    try {
        ...
        if (!responseText) throw new Error("API не вернул текст.");
...
const addCopyButtonToCodeBlocks = () => {
    ...
    codeBlocks.forEach((block) => {
        ...
        let language = [...codeElement.classList].find(cls => cls.startsWith('language-'))?.replace('language-', '') || 'Текст';
